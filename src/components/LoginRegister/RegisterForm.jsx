...
export const RegisterForm = () => {
    const { setLogReg, showPassword, visiblePassword } = useAppContext()
        ...
        <form className="secondFont text-[#000000e0] flex flex-col gap-y-2 w-[300px]">
            ...
            <div>
                ...
                <div className="px-4 py-[7px] bg-[#f6f7fb] border border-[#999999] rounded-lg">
                    <input type="text" name="user-name" id="user-name" placeholder="İstifadəçi adı" className="bg-transparent w-full outline-none" />
                </div>
            </div>
            <div>
                <label htmlFor="email" className="mb-1 block">Email</label>
                <div className="px-4 py-[7px] bg-[#f6f7fb] border border-[#999999] rounded-lg">
                    <input type="text" name="email" id="email" placeholder="Email daxil edin" className="bg-transparent w-full outline-none" />
                </div>
            </div>
            <div>
                ...
                <div className="px-4 py-[7px] flex bg-[#f6f7fb] border border-[#999999] rounded-lg">
                    <input type={`${visiblePassword ? "text" : "password"}`} name="password" id="password" placeholder="Şifrəni daxil edin" className="bg-transparent w-full outline-none" />
            ...
            <button type="submit" className="py-2 bg-primary text-white rounded-lg">
                Qeydiyyat
            </button>
